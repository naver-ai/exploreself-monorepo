...
const generateReflexiveQuestionsController = async (req: Request, res: Response) => {
...
export {generateReflexiveQuestionsController, generateOrientincQuestionsController}