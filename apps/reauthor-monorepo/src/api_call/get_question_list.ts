...
export const getSelectedQuestionList = async (token: string, tid: string): Promise<string[] | null> => {
  try {
...
export const getUnselectedQuestionList = async (token: string, tid: string): Promise<string[] | null> => {
  try {
