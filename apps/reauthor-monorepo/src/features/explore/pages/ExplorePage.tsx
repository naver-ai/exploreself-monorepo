...
const SidePanel = () => {
  ...
  return <>
    <div id="sidebar-header" className="flex justify-between p-3 items-center  border-b-[1px]">
...
export const ExplorerPage = () => {
  ...
  } else return <div className="h-screen flex justify-stretch">
      ...
      <div className="overflow-y-scroll h-screen overflow-x-hidden" ref={scrollViewRef}>
        ...
        <div className="container px-4 md:px-8 py-4 md:py-8 relative">
          ...
          <Button key={"new-theme-btn-bottom"} ref={ref} type="primary"
            ...
            icon={<LightBulbIcon className="w-5 h-5" />} onClick={onThemeSelectionButtonClick}>
        ...
        {
          inView === false ? <div className="absolute bottom-0 left-0 right-0 px-4 mx:px-8 bg-gradient-to-t from-white to-white/0 py-8">
